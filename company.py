...
class Company:
    ...
    # ddm
    def calcGGM(self, required_rate_of_return, selling_price=0):
        return 0

    # Gordon growth model
    # constant growth rate
    def calcGGM(self, required_rate_of_return, growth_rate, selling_price):
        return 0

    def calcConstantGrowhtRate(self):
        return 0

    def calcPayoutRatio(self):
        return 0

    # plowback ratio
    # 1 - (payoutratio / eps)
    def calcPlowbackRatio(self):
        return 0

    # dividend yield
    # annual dividend / currrent share price
    def calcDivYield(self):
        return 0

    # present value of growth opportunities
    # value with growth opportunities - value without growth opportunities
